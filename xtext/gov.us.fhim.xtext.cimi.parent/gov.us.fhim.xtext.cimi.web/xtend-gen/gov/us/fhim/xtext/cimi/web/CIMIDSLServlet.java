...
import gov.us.fhim.xtext.cimi.web.CIMIDSLWebSetup;
...
public class CIMIDSLServlet extends XtextServlet {
  ...
  public void init() {
    try {
      ...
      CIMIDSLWebSetup _cIMIDSLWebSetup = new CIMIDSLWebSetup(executorServiceProvider);
      _cIMIDSLWebSetup.createInjectorAndDoEMFRegistration();
    } catch (Throwable _e) {
