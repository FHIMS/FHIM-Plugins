...
public class InternalCIMIDSLLexer extends Lexer {
    ...
    public final void mT__48() throws RecognitionException {
        try {
            int _type = T__48;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCIMIDSL.g:47:7: ( '[' )
            // InternalCIMIDSL.g:47:9: '['
            {
            match('['); 
    ...
    public final void mT__49() throws RecognitionException {
        try {
            int _type = T__49;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCIMIDSL.g:48:7: ( ']' )
            // InternalCIMIDSL.g:48:9: ']'
            {
            match(']'); 
    ...
    public final void mT__50() throws RecognitionException {
        try {
            int _type = T__50;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCIMIDSL.g:49:7: ( 'matches' )
            // InternalCIMIDSL.g:49:9: 'matches'
            {
            match("matches"); 
    ...
    public final void mT__51() throws RecognitionException {
        try {
            int _type = T__51;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCIMIDSL.g:50:7: ( '{\\r' )
            // InternalCIMIDSL.g:50:9: '{\\r'
            {
            match("{\r"); 
    ...
    public final void mT__52() throws RecognitionException {
        try {
            int _type = T__52;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCIMIDSL.g:51:7: ( '}\\r' )
            // InternalCIMIDSL.g:51:9: '}\\r'
            {
            match("}\r"); 
    ...
    public final void mRULE_MYSTRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCIMIDSL.g:1792:15: ( ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* )
            // InternalCIMIDSL.g:1792:17: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
            {
            // InternalCIMIDSL.g:1792:17: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
            loop1:
            do {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCIMIDSL.g:1794:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalCIMIDSL.g:1794:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalCIMIDSL.g:1794:11: ( '^' )?
            int alt2=2;
            ...
            // InternalCIMIDSL.g:1794:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCIMIDSL.g:1796:10: ( ( '0' .. '9' )+ )
            // InternalCIMIDSL.g:1796:12: ( '0' .. '9' )+
            {
            // InternalCIMIDSL.g:1796:12: ( '0' .. '9' )+
            int cnt4=0;
            loop4:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCIMIDSL.g:1798:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalCIMIDSL.g:1798:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalCIMIDSL.g:1798:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    // InternalCIMIDSL.g:1798:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalCIMIDSL.g:1798:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
                    ...
                    break;
                case 2 :
                    // InternalCIMIDSL.g:1798:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalCIMIDSL.g:1798:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCIMIDSL.g:1800:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalCIMIDSL.g:1800:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalCIMIDSL.g:1800:24: ( options {greedy=false; } : . )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCIMIDSL.g:1802:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalCIMIDSL.g:1802:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalCIMIDSL.g:1802:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCIMIDSL.g:1804:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalCIMIDSL.g:1804:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalCIMIDSL.g:1804:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt12=0;
            loop12:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCIMIDSL.g:1806:16: ( . )
            // InternalCIMIDSL.g:1806:18: .
            {
            matchAny(); 
    ...
    static final String DFA13_acceptS =
        "\31\uffff\1\56\5\uffff\1\56\3\uffff\1\2\1\4\3\uffff\1\10\6\uffff\1\16\1\uffff\1\17\1\20\1\uffff\1\61\1\65\1\23\1\uffff\1\46\3\uffff\1\45\7\uffff\1\56\6\uffff\1\7\10\uffff\1\25\1\22\1\26\5\uffff\1\40\1\41\1\42\1\43\1\uffff\1\50\1\51\4\uffff\1\62\2\uffff\1\56\1\uffff\1\63\14\uffff\1\27\11\uffff\1\56\13\uffff\1\54\3\uffff\1\32\1\35\54\uffff\1\21\10\uffff\1\47\5\uffff\1\24\12\uffff\1\1\2\uffff\1\6\1\11\10\uffff\1\30\17\uffff\1\5\1\uffff\1\55\1\13\10\uffff\1\3\1\12\1\14\5\uffff\1\33\1\34\2\uffff\1\53\2\uffff\1\31\6\uffff\1\15\2\uffff\1\52\2\uffff\1\44\4\uffff\1\36\1\37";
    static final String DFA13_specialS =
        "\1\36\1\uffff\1\5\1\12\3\uffff\1\30\4\uffff\1\34\1\10\1\41\1\4\1\45\2\uffff\1\17\3\uffff\1\60\4\uffff\1\61\12\uffff\1\44\10\uffff\1\6\2\uffff\1\42\3\uffff\1\7\6\uffff\1\1\1\3\2\uffff\1\37\1\57\1\uffff\1\43\1\23\20\uffff\1\31\13\uffff\1\55\1\14\1\2\1\51\1\uffff\1\46\2\uffff\1\26\12\uffff\1\27\10\uffff\1\16\1\11\1\47\2\uffff\1\25\53\uffff\1\21\10\uffff\1\20\4\uffff\1\53\14\uffff\1\52\2\uffff\1\0\1\50\10\uffff\1\32\23\uffff\1\40\1\63\1\56\10\uffff\1\33\1\uffff\1\54\2\uffff\1\62\13\uffff\1\24\2\uffff\1\35\12\uffff\1\15\2\uffff\1\22\4\uffff\1\13\10\uffff}>";
